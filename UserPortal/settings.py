...
SECRET_KEY = 'django-insecure-1-pu829)&jui4ei4h5d=pt=f35fwg-0irbc%=8mbz@sca@#ebn'
...
# This line tells Celery where to look for the tasks.
CELERY_IMPORTS = ('profileapp.tasks', )  # Add your task module